...
export const teachers = [
  { subject: "국어", name: "김서현", grades: ["N수"], img: "/clavis/teacher-1.png", isNew: true },
  { subject: "국어", name: "이준호", grades: ["N수", "고3"], img: "/clavis/teacher-2.png", isNew: false },
  { subject: "수학", name: "박태민", grades: ["N수"], img: "/clavis/teacher-3.png", isNew: true },
  { subject: "수학", name: "최윤아", grades: ["N수", "고3"], img: "/clavis/teacher-4.png", isNew: false },
  { subject: "영어", name: "정민석", grades: ["N수"], img: "/clavis/teacher-5.png", isNew: false },
  { subject: "영어", name: "한지우", grades: ["N수", "고3"], img: "/clavis/teacher-6.png", isNew: true },
  { subject: "탐구", name: "오세영", grades: ["N수"], img: "/clavis/teacher-7.png", isNew: false },
  { subject: "탐구", name: "윤도현", grades: ["N수"], img: "/clavis/teacher-8.png", isNew: false },
];
