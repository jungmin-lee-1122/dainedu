      ...
      <section className="dn-grade-sec">
        <div className="dn-wrap dn-grade-in">
          ...
          <div className="dn-grade" role="tablist" aria-label="과정 전환">
            <span className="dn-grade-thumb" data-pos="right" aria-hidden="true" />
            <a className="dn-grade-btn" href="/clavis" role="tab" aria-selected={false}>
              <b>고등</b>
              <i>클라비스</i>
            </a>
            <a className="dn-grade-btn is-on" href="/aurum" role="tab" aria-selected={true}>
              <b>N수</b>
              <i>아우룸</i>
            </a>
          </div>
