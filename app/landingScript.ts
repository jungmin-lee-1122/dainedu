...
(function(){var el=document.getElementById("dnClock");if(!el)return;function p(x){return (x<10?"0":"")+x;}function tick(){var d=new Date();el.textContent=p(d.getHours())+":"+p(d.getMinutes())+":"+p(d.getSeconds());}tick();setInterval(tick,1000);})();
`;
