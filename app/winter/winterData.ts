...
/** icon — FlowIcon.tsx 의 아이콘 종류 */
export const aiSteps = [
  { no: "01", t: "학습 정보 수집", d: "질문 기록, 시험 오답, 학습 데이터를 분석의 기초 자료로 수집", icon: "collect" as const },
  { no: "02", t: "AI 학습 분석", d: "누적된 정보를 분석해 학생별 취약 영역과 학습 패턴을 진단", icon: "analyze" as const },
  { no: "03", t: "맞춤 방향 제안", d: "분석 결과를 바탕으로 개선 방향과 맞춤 학습법을 제시", icon: "suggest" as const },
  { no: "04", t: "상담 및 연계 관리", d: "결과에 맞춰 1:1 상담을 연계하고 후속 학습까지 관리", icon: "care" as const },
];
