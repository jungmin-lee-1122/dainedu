...
export const careCards: { no: string; name: string; en: string; lead: string; items: CareItem[] }[] = [
  {
    ...
    lead: "배운 내용을 실력으로 완성",
    items: [
      { t: "1:1 멘토링 코칭", d: "개인별 학습 진단" },
      { t: "대면 질의응답", d: "즉각적인 문제 해결" },
      { t: "1:1 수학 책임담임제", d: "성취도 진단 & 맞춤 지도" },
      { t: "학교별 기출 & 전국 모의고사" },
      { t: "학년별 · 수준별 맞춤", d: "전과목 커리큘럼" },
    ],
  },
  {
    no: "02",
    ...
    lead: "명문대 합격을 위한 설계",
    items: [
      { t: "학생부 심층진단", d: "생기부 분석으로 목표 대학 매칭" },
      { t: "로드맵 포트폴리오", d: "성취도 & 적성 기반 전형 설계" },
      { t: "시즌별 입시 전략 특강", d: "입시 맞춤형 테마 특강" },
    ],
  },
  {
    no: "03",
    name: "생활 케어",
    en: "DAILY CARE",
    lead: "공부에만 집중할 수 있는 환경 조성",
    items: [
      { t: "학습 플래너", d: "매일의 계획과 실행도 점검" },
      { t: "1:1 피드백", d: "학습 습관 초밀착 관리" },
      { t: "스마트폰 세이브존", d: "등원 즉시 전자기기 수거" },
      { t: "개인별 11인치 태블릿", d: "학습 외 모든 사이트 완전 차단" },
    ],
  },
  {
    no: "04",
    name: "몰입 규정",
    en: "RULE & FOCUS",
    lead: "학습 분위기 조성을 위한 엄격한 규정",
    items: [
      { t: "벌점 패널티 시스템", d: "방해 요소 엄격 차단" },
      { t: "불필요 접속 차단", d: "학습 외 사이트 제한" },
      { t: "원스트라이크 퇴원 규정" },
    ],
  },
];
...
export const recordChips = [
  { t: "데일리 TEST", d: "0교시·데일리 테스트로 학습이 자리 잡았는지 확인" },
  { t: "성적 Tracking", d: "테스트와 모의고사를 누적해 과목별 변화까지 파악" },
  { t: "오답 분석", d: "반복해서 틀리는 문제와 질문 기록으로 취약 영역 정리" },
  { t: "1:1 맞춤 케어", d: "학습 기록과 성취도를 분석해 보완 방향을 제시" },
];
