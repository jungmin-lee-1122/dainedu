    ...
    <ul class="dn-gnb">
      ...
      <li class="dn-gnb-item">
        ...
        <div class="dn-gnb-sub dn-gnb-sub-grouped">
          ...
          <span class="dn-gnb-soon">독학재수반</span>
          <span class="dn-gnb-gtitle">고등부 단과</span>
      ...
      <div class="dn-wrap">
        <div class="dn-rolling-row">
          <div class="dn-slider" id="dnSlider">
            <div class="dn-slides">
              <div class="dn-slide"><picture><source media="(max-width:900px)" srcset="/slideA-m.png"/><img src="/slideA.png" alt="다인교육 그랜드 오픈"/></picture></div>
    ...
    <div class="dn-wrap dn-foot">
      <div class="dn-foot-left">
        ...
        <div class="dn-foot-tel-wrap">
          <button class="dn-foot-tel" id="footTelBtn" type="button" aria-expanded="false" aria-label="대표번호 펼치기">1644-0224<span class="dn-foot-tel-caret" aria-hidden="true">▾</span></button>
          <div class="dn-foot-tel-menu" id="footTelMenu">
            <a href="tel:16440224"><span class="dn-tel-label">대표번호</span><span class="dn-tel-num">1644-0224</span></a>
        ...
        <div class="dn-foot-info">
          ...
          <p>개인정보보호책임자: 김양현<span class="dn-foot-sep">|</span>대표번호 1644-0224<span class="dn-foot-sep">|</span>주소: 경기도 화성시 동탄 메타폴리스로 53, 6층</p>
